...
export default function EditPost({ params }) {
	...
	async function checkAccess() {
		...
		const isOwner = postData.author_id === currentUser.id;
...
transition-all duration-300">
          ...
          ">
					...
					<div className="relative z-10">
						<div className="mb-12">
							<h1
								className="mb-4 text-2xl sm:text-4xl md:text-5xl lg:text-6xl 
font-semibold
tracking-[-0.05em]
...
max-w-xl">
						...
						{message && <p className="mb-8 text-green-400">{message}</p>}
                ...
                "
                  ...
                  w-full sm:w-auto justify-center px-6 sm:px-8 py-3 sm:py-4
                  font-medium
                  text-white
                  transition-all duration-300
                  hover:scale-[1.02]

...
export default function WriterPage({ params }) {
	...
	if (!writer) {
		return (
			<main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050506] text-zinc-400">
				...
				<p className="relative z-10 text-lg">Loading profile...</p>
			</main>
		);
	}

	return (
		<main className="relative min-h-screen overflow-hidden bg-[#050506] px-4 sm:px-6 py-6 sm:py-10 text-white">
			{/* Background */}
			<div className="pointer-events-none absolute inset-0 overflow-hidden">
				<div className="absolute inset-0 bg-gradient-to-b from-[#050506] via-[#0d0e12] to-[#050506]" />

				<div className="hidden sm:block animate-floatSlow absolute left-[-8%] top-[0%]">
					<div
			...
			<div className="relative z-10 mx-auto max-w-6xl">
				...
				<button
					...
					className="
            mb-5 sm:mb-8 flex items-center gap-3
            rounded-2xl
          ...
          ">
					...
					<div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
						<div className="flex items-center gap-6">
							<div className="relative">
								...
								<div
									className="
                    relative flex h-16 w-16 sm:h-24 sm:w-24
                  ...
                  ">
                      ...
                      "
							...
							<div>
								<h1 className="mb-2 text-2xl sm:text-4xl md:text-5xl font-semibold tracking-[-0.05em]">
									{writer.name}
								</h1>

								<p className="max-w-xl text-zinc-400 leading-6 sm:leading-8">
									{writer.bio || " "}
								</p>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="rounded-2xl border border-white/[0.04] bg-white/[0.02] p-3 sm:p-5">
  ...
  ">
					<div className="mb-8 flex items-center justify-between">
						...
						<p className="text-sm text-zinc-400">{posts.length} stories</p>
					</div>
        ...
        ">
              ...
              "
									...
									<div className="p-3 sm:p-5">
										<h2
											className="mb-2 text-[11px] sm:text-xl
font-medium sm:font-semibold
leading-[1.35]
tracking-[-0.01em] font-semibold tracking-[-0.03em] leading-tight">
											{post.title}
										</h2>

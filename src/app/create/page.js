...
export default function CreatePost() {
	...
	async function handleCreate() {
		...
		if (!title.trim() || !body.trim()) {
			setMessage("Please add a title and your story content.");
			return;
		}
		...
		if (!session) {
			setMessage("Please sign in to publish your story.");
			return;
		}
		...
		<main className="relative min-h-screen overflow-hidden bg-[#050506] text-white">
			<div className="pointer-events-none absolute inset-0 overflow-hidden">
				...
				<div className="animate-floatSlow absolute left-[-8%] top-[0%]">
					<div
						className="hidden sm:block h-[560px] w-[500px] opacity-90 blur-[95px]"
						style={{
					...
					<div className="relative z-10">
						...
						<div className="mb-12">
							<div className="mb-4 flex items-center gap-3">
								<PenLine size={22} className="text-violet-300" />

								<h1 className="text-2xl sm:text-4xl md:text-5xl leading-tight font-semibold text-zinc-100">
						...
						{message && <p className="mb-8 text-red-400">{message}</p>}
